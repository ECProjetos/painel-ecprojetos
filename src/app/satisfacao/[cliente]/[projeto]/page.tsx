...
import { SendNpsForm } from "@/app/actions/satisfacao/nps-form"
import {
  Card,
  CardContent,
  CardDescription,
...
export default function FormSatisfacao() {
  ...
  const sendNpsFormWithParams = SendNpsForm.bind(null, cliente, projeto)
      ...
      <form action={formAction}>
        <CardContent className="space-y-6">
          ...
          <div className="space-y-4 gap-3 mt-10">
            {renderLinearScale(
              "satisfacaoGeral",
              "De 1 a 5, qual foi o seu nível de satisfação geral com o projeto entregue?"
            )}

            <h3 className="font-bold mt-7">
              Qual foi o seu nível de satisfação com o projeto entregue para estes itens específicos:
            </h3>
