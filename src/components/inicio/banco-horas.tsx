          ...
          {timeData.data.map((user) => (
            ...
            >
              ...
              <div className="text-sm text-[#444] mb-1">
                Trabalhadas: {formatHour(user.horas_trabalhadas)} | Esperadas:{" "}
                {formatHour(user.horas_a_fazer)}
              </div>

              <div className="text-xs text-[#888]">
                Banco anterior: {formatHour(user.banco_horas_anterior)}
              </div>
