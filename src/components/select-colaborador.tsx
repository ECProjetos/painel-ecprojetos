...
import {
  getAllColaboradores,
  getColaboradoresByDepartamento,
  getDepartamentoByID,
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
          {listaFiltrada.map((colab) => (
            <div
              ...
              className={`flex items-center p-4 bg-white dark:bg-gray-800 rounded-xl shadow hover:shadow-lg cursor-pointer transition ${
                colaboradorId === colab.id ? "ring-2 ring-blue-400" : ""
              }`}
            >
