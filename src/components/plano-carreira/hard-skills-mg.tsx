...
import {
    HardSkillsMeioAmbienteSchema,
    HardSkillsMeioAmbienteType
...
type SoftSkillsTableProps = {
    ...
    evaluatorId: string;
    onSubmit?: (respostas: HardSkillsMeioAmbienteType) => void;
};

export function HardSkillsMgTable({
    habilidadesDetalhadas,
    opcoes,
    evaluatorId,
    onSubmit,
    ...
    const handleSubmit = (e: React.FormEvent) => {
        ...
        const parseResult = HardSkillsMeioAmbienteSchema.safeParse(dadosParaValidar);
