...
export function PortfolioForm({
  ...
  const [form, setForm] = useState({
    ...
    associated_investment: numberToInput(
  ...
  function handleSubmit(
    ...
    const data: PortfolioFormInput = {
      ...
      associated_investment: parseOptionalNumber(
        form.associated_investment,
      ),
      ...
      notes: form.notes,
      allow_external_export:
        form.allow_external_export,
      show_values_in_pdf:
        form.show_values_in_pdf,
    }
    ...
    >
      ...
      <section className="space-y-5 rounded-xl border p-5">
        <div>
          ...
          <p className="text-sm text-muted-foreground">
            Registre as informações que serão utilizadas
            na apresentação do projeto no portfólio.
          </p>
        </div>
        ...
        <div className="space-y-2">
          <Label htmlFor="quantitative_results">
      ...
      <section className="space-y-5 rounded-xl border p-5">
        <div>
          ...
          <p className="text-sm text-muted-foreground">
            Valores associados ao empreendimento ou projeto
            desenvolvido.
          </p>
        </div>
        ...
        <div className="grid gap-5 md:grid-cols-2">
          ...
          <div className="space-y-2">
            ...
            <p className="text-xs text-muted-foreground">
              Valor do empreendimento associado ao case,
              quando aplicável.
            </p>
          </div>
          ...
          <div className="space-y-2">
            ...
            <Input
              ...
              value={form.capex}
              onChange={(event) =>
                updateField("capex", event.target.value)
              }
            />
          </div>
        </div>
        ...
        <div className="space-y-4 rounded-lg bg-muted/40 p-4">
          <label className="flex cursor-pointer items-start gap-3">
            ...
            <div>
              <p className="text-sm font-medium">
                Permitir exportação externa
              </p>

              <p className="text-xs text-muted-foreground">
                Indica que o conteúdo poderá futuramente
                ser utilizado em materiais comerciais externos.
              </p>
            </div>
          </label>
          ...
          <label className="flex cursor-pointer items-start gap-3">
            ...
            <div>
              ...
              <p className="text-xs text-muted-foreground">
                Define se investimento e CAPEX poderão aparecer
                na futura exportação do projeto.
              </p>
            </div>
          </label>
        </div>
